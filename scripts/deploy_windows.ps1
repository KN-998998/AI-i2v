...
$firewallRule = Get-NetFirewallRule -ErrorAction Stop | Where-Object { $_.Name -eq "AI-i2v-FastAPI-8015" -or $_.DisplayName -eq "AI-i2v FastAPI 8015" } | Select-Object -First 1
